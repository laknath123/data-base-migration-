...
quarters<- str_replace_all(quarters, "9", "4") # Replacing the regex that's somehow reading 4 as 9.


#function for combining file meta data information with file created
FUN_metainfo_combine <- function(filestoread=filenames[23:length(filenames)],sheetname,skipnumber){
...
bs_df.list<- FUN_metainfo_combine(filestoread=filenames[23:length(filenames)],
